defmodule OsuAPI.Utils do
  ...
  ## Examples
      ...
      iex> OsuAPI.Utils.mode(0)
      :standard

      iex> OsuAPI.Utils.mode(:taiko)
      1
  """
  def mode(_m)
  ...
  ## Examples
      ...
      iex> OsuAPI.Utils.approved(-2)
      :graveyard

      iex> OsuAPI.Utils.approved(:wip)
      -1
  """
  def approved(_a)
  ...
  ## Examples
      ...
      iex> OsuAPI.Utils.genre(0)
      :any

      iex> OsuAPI.Utils.genre(:unspecified)
      1
  """
  def genre(_g)
  ...
  ## Examples
      ...
      iex> OsuAPI.Utils.language(0)
      :any

      iex> OsuAPI.Utils.language(:other)
      1
  """
  def language(_l)
  ...
  ## Examples
      ...
      iex> OsuAPI.Utils.scoring_type(0)
      :score

      iex> OsuAPI.Utils.scoring_type(:accuracy)
      1
  """
  def scoring_type(_s)
  ...
  ## Examples
      ...
      iex> OsuAPI.Utils.team_type(0)
      :head_to_head

      iex> OsuAPI.Utils.team_type(:tag_coop)
      1
  """
  def team_type(_t)
  ...
  ## Examples
      ...
      iex> OsuAPI.Utils.team(1)
      :blue

      iex> OsuAPI.Utils.team(:red)
      2
  """
  def team(_t)
  ...
  ## Examples
      iex> OsuAPI.Utils.mods(24) |> elem(1) |> MapSet.to_list()
      [:HD, :HR]

      iex> OsuAPI.Utils.mods([:DT, :FL])
      {:ok, 1088}

      iex> OsuAPI.Utils.mods([:QQ])
      {:error, {:unknown_mod, :QQ}}
  """
  def mods(_m)

  @spec mods(0..2147483647) :: {:ok, MapSet.t()}
  ...
  @spec mods(Enum.t()) :: {:ok, 0..2147483647} | {:error, {:unknown_mod, atom}}
